void currentcompare()
{
	...
	TH1F* sig0 = new TH1F("current_aval","current signal;Time(ns);Signal(#muA)",4000,0,4000);
	TH1F* sig = new TH1F("charge_button","current signal;Time(ns);Signal(#muA)",4000,0,4000);
